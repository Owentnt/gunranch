INSERT INTO GUNS(ID, NAME, GUN_TYPE,MAGAZINE,CALIBER,PRICE,IMAGE,BIO)
VALUES (1, 'Glock-19', 'Handgun', 15, '9x19 mm', 8, '/images/glock19.png','The Glock 19 is a popular 9mm semi-automatic pistol known for its reliability,
 ...
 INSERT INTO GUNS(ID, NAME, GUN_TYPE, MAGAZINE, CALIBER, PRICE,IMAGE,BIO)
VALUES (2, 'Desert Eagle', 'Handgun', 8, '.44 Magnum', 8, '/images/desert_eagle.png','The Desert Eagle is a powerful semi-automatic pistol
    ...
    INSERT INTO GUNS(ID, NAME, GUN_TYPE, MAGAZINE, CALIBER, PRICE, IMAGE, BIO)
VALUES (3, 'Walther P22 Junior', 'Handgun', 10, '.22 LR', 9, '/images/waltherp22junior.png ','The Walther P22 Junior is a compact and lightweight semi-automatic pistol
    ...
    INSERT INTO GUNS (ID, NAME, GUN_TYPE, MAGAZINE, CALIBER, PRICE, IMAGE,BIO)
VALUES (4, 'Smith & Wesson 686', 'Handgun', 6, '.38 Special/.357 Magnum Magnum', 12, '/images/smithandwessen686.png ','The Smith & Wesson Model 686 is a popular double-action revolver known for its durability and versatility.
    ...
    INSERT INTO GUNS(ID, NAME, GUN_TYPE, MAGAZINE, CALIBER, PRICE, IMAGE,BIO)
VALUES (5, 'Taurus 95', 'Handgun', 8, '.22 LR', 10, '/images/Taurus_95.png','The Taurus Model 95 is a revolver designed and manufactured by the Brazilian firearms company Taurus International.
    ...
    INSERT INTO GUNS (ID, NAME, GUN_TYPE, MAGAZINE, CALIBER, PRICE,IMAGE,BIO)
VALUES (6, 'Ruger Super Redhawk', 'Handgun', 6, '44 Special/.44 Magnum Magnum', 12, '/images/Redhawk.png ','The Ruger Super Redhawk is a line of double-action revolvers manufactured by Sturm, Ruger & Co.
...
VALUES (8,'Steyr Aug','Assault Rifle',30,'5.56x45 mm', 15, '/images/steyr_aug.png','The Steyr AUG (Armee-Universal-Gewehr, or Universal Army Rifle) is an Austrian bullpup assault rifle designed in the 1970s.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER, PRICE,IMAGE,BIO)
VALUES (9,'Mosin Nagant','Sniper Rifle',5,'7.62x54 mm', 15,'/images/mosin_nagant.png','The Mosin-Nagant is a bolt-action rifle that originated in Russia
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER, PRICE, IMAGE,BIO)
VALUES (10,'AR-15','Assault Rifle',30,'5.56x45 mm', 12, '/images/AR15.png','The AR-15 is a lightweight, magazine-fed, gas-operated, and air-cooled rifle.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER,PRICE,IMAGE,BIO)
VALUES (11,'UZI','Submachine Gun',25,'9x19 mm',18,'/images/UZI.png','The UZI is an Israeli submachine gun that gained global recognition.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER,PRICE,IMAGE,BIO)
VALUES (12,'Mossberg 590A1','Shotgun',8,'12 GA',15,'/images/mossberg590A1.png','The Mossberg 590A1 is a pump-action shotgun known for its durability and reliability.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER,PRICE, IMAGE,BIO)
VALUES (13,'Saiga 12','Shotgun',5,'12 GA',15,'/images/Saiga12.png','The Saiga-12 is a Russian-made semi-automatic shotgun designed for both civilian and military use.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER,PRICE,IMAGE,BIO)
VALUES (14,'M14','Assault Rifle',20,'7.62x51 mm',12,'/images/M14.png','The M14 is a selective fire, magazine-fed battle rifle adopted by the United States military in the late 1950s.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER,PRICE,IMAGE,BIO)
VALUES (15,'M16A1 Vietnam','Assault Rifle',30,'5.56x45 mm',12,'/images/M16A1Vietnam.png','The M16A1 was the standard issue rifle for U.S. troops during the Vietnam War.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER, PRICE,IMAGE,BIO)
VALUES (16,'Colt M1911','Handgun',7,'.45 ACP',10,'/images/colt1911.png','The Colt M1911 is a renowned semi-automatic pistol designed by John Browning and adopted by the United States military in 1911.
...
INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER, PRICE, IMAGE,BIO)
VALUES (17,'M1 Garand','Sniper Rifle',8,'.30-06 Springfield Ridge',24, '/images/M1GARAND.png','The M1 Garand is a semi-automatic rifle that gained prominence during World War II and became the standard-issue rifle for the United States military.
...
INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER, PRICE,IMAGE,BIO)
VALUES (18,'Mauser Kar98K','Sniper Rifle',5,'7,92x57mm',15,'/images/mauser.png','The Mauser Karabiner 98 Kurz, commonly known as the Kar98k, is a bolt-action rifle that gained widespread recognition and use during World War II.');
