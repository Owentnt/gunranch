...
VALUES (4, 'Smith & Wesson 686', 'Handgun', 6, '.38 Special Magnum', 12, '/images/smithandwessen686.png ','Neither Semi-Auto nor Full-Auto','The Smith & Wesson Model 686 is a popular double-action revolver known for its durability and versatility.
    ...
    INSERT INTO GUNS(ID, NAME, GUN_TYPE, MAGAZINE, CALIBER, PRICE, IMAGE,FIREARMS_TYPE,BIO)
VALUES (5, 'Taurus 95', 'Handgun', 8, '.22 LR', 10, '/images/Taurus_95.png','Neither Semi-Auto nor Full-Auto','The Taurus Model 95 is a revolver designed and manufactured by the Brazilian firearms company Taurus International.
    ...
    INSERT INTO GUNS (ID, NAME, GUN_TYPE, MAGAZINE, CALIBER, PRICE,IMAGE,FIREARMS_TYPE,BIO)
VALUES (6, 'Ruger Super Redhawk', 'Handgun', 6, '44 Special/.44 Magnum Magnum', 12, '/images/Redhawk.png ','Neither Semi-Auto nor Full-Auto','The Ruger Super Redhawk is a line of double-action revolvers manufactured by Sturm, Ruger & Co.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER, PRICE,IMAGE,FIREARMS_TYPE,BIO)
VALUES (7,'Kalashnikov Classic','Assault Rifle',35,'7.62x25 mm', 15, '/images/kalashnikov.png','Both Semi-Auto and Full-Auto','The Kalashnikov Classic refers to a series of firearms designed by Mikhail Kalashnikov,
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER, PRICE,IMAGE,FIREARMS_TYPE,BIO)
VALUES (8,'Steyr Aug','Assault Rifle',30,'5.56x45 mm', 15, '/images/steyr_aug.png','Both Semi-Auto and Full-Auto','The Steyr AUG (Armee-Universal-Gewehr, or Universal Army Rifle) is an Austrian bullpup assault rifle designed in the 1970s.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER, PRICE,IMAGE,FIREARMS_TYPE,BIO)
VALUES (9,'Mosin Nagant','Sniper Rifle',5,'7.62x54 mm', 15,'/images/mosin_nagant.png','Neither Semi-Auto nor Full-Auto','The Mosin-Nagant is a bolt-action rifle that originated in Russia
...
VALUES (11,'UZI','Submachine Gun',25,'9x19 mm',18,'/images/UZI.png','Full-Auto','The UZI is an Israeli submachine gun that gained global recognition.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER,PRICE,IMAGE,FIREARMS_TYPE,BIO)
VALUES (12,'Mossberg 590A1','Shotgun',8,'12 GA',15,'/images/mossberg590A1.png','Neither Semi-Auto nor Full-Auto','The Mossberg 590A1 is a pump-action shotgun known for its durability and reliability.
...
VALUES (13,'Saiga 12','Shotgun',5,'12 GA',15,'/images/Saiga12.png','Semi-Auto','The Saiga-12 is a Russian-made semi-automatic shotgun designed for both civilian and military use.
    ...
    INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER,PRICE,IMAGE,FIREARMS_TYPE,BIO)
VALUES (14,'M14','Assault Rifle',20,'7.62x51 mm',12,'/images/M14.png','Both Semi-Auto or Full-Auto','The M14 is a selective fire, magazine-fed battle rifle adopted by the United States military in the late 1950s.
...
INSERT INTO GUNS(ID,NAME,GUN_TYPE,MAGAZINE,CALIBER, PRICE,IMAGE,FIREARMS_TYPE,BIO)
VALUES (18,'Mauser Kar98K','Sniper Rifle',5,'7,92x57mm',15,'/images/mauser.png','Neither Semi-Auto nor Full-Auto','The Mauser Karabiner 98 Kurz, commonly known as the Kar98k, is a bolt-action rifle that gained widespread recognition and use during World War II.');
...
-- VALUES (1,'Owen','Talboom','owentm031111@gmail.com','0494 31 00 04','4',08/03/2023,20:00,true);
--
-- INSERT INTO RESERVATION(ID,FIRST_NAME,LAST_NAME,EMAIL_ADDRESS,PHONE_NUMBER,AMOUNT_OF_PARTICIPANTS,DATE,TIME,MEMBER,ADDRESS,CITY)
...
VALUES (1,'Owen','Talboom','owentm031111@gmail.com','0494 31 00 04');

INSERT INTO USERS(ID,FIRST_NAME,LAST_NAME,EMAIL_ADDRESS,PHONE_NUMBER)
VALUES (2,'Sara','Pasteels','sara.pasteels@hotmail.be','0477 83 14 10');

INSERT INTO USERS(ID,FIRST_NAME,LAST_NAME,EMAIL_ADDRESS,PHONE_NUMBER)
VALUES (3,'Milan','Keymolen','milankeymolen@outlook.com','0468 41 36 18');

INSERT INTO USERS(ID,FIRST_NAME,LAST_NAME,EMAIL_ADDRESS,PHONE_NUMBER)
VALUES (4,'Tibi','Dewulf','tibidewulf@gmail.com','0475 50 81 15');

INSERT INTO USERS(ID,FIRST_NAME,LAST_NAME,EMAIL_ADDRESS,PHONE_NUMBER)
VALUES (5,'Kobe','Verstrepen','kobe_vrstrpn@hotmail.be','0478 29 56 59');

INSERT INTO USERS(ID,FIRST_NAME,LAST_NAME,EMAIL_ADDRESS,PHONE_NUMBER)
VALUES (6,'Rafael','Rodriguez','rafaelrodriguez@gmail.be','0468 31 25 55');

INSERT INTO USERS(ID,FIRST_NAME,LAST_NAME,EMAIL_ADDRESS,PHONE_NUMBER)
VALUES (7,'Yaron','Vansteenkiste','yaronvsk@hotmail.be','0476 72 50 06');
...
INSERT INTO COMPETITIONS(ID,TITLE,STARTING_HOUR,ENDING_HOUR,DATE,REGISTRATION_DEADLINE,
                         PARTICIPATION_PRICE,ALLOWED_FIREARMS_ID,OBJECTIVE,IMAGE,
                         RULES,ROUNDS,TIME_LIMIT,SAFETY)
VALUES (1,'Bullseye Shooting Academy',14:00,17:00,18/05/2024,11/05/2024,25,1,
        ...
        which typically has a series of concentric circles.','',
        ...
        with the highest points awarded for shots closest to the center.',10,1:00,'Lol')